...
dscli.el 是一个 Emacs 插件，为 [dscli](https://github.com/dscli/dscli) 命令行工具提供界面。我们的目标是：
...
- 新增 dscli-convert-markdown-to-org 自定义变量
- 支持 Org 模式格式输出，更好的 Emacs 集成
- 更新相关文档和示例
```
...
### 1. 环境设置
1. 克隆仓库
2. 安装 dscli 工具：`go install github.com/dscli/dscli@latest`
3. 配置开发环境
...
### 问题报告
- 使用 GitHub 的 Issues 跟踪系统
- 提供详细的重现步骤
- 包括环境信息和相关日志

### 讨论交流
- 使用 GitHub 的 Discussions 功能
- 保持专业和友好的交流氛围
- 尊重所有贡献者
...
- 项目仓库：https://github.com/dscli/dscli.el
- 问题跟踪：https://github.com/dscli/dscli.el/issues
